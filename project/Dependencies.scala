...
object Dependencies {
  ...
  val workbenchGoogleV = "0.10-0967a99"
  ...
  val workbenchServiceTests: ModuleID = "org.broadinstitute.dsde.workbench" % "workbench-service-test_2.12" % "0.1.1-alpha-sam-eb037a4-SNAP" % "test" classifier "tests"
