...
object Dependencies {
  ...
  val opencensusStackDriverExporter: ModuleID = "io.opencensus" % "opencensus-exporter-trace-stackdriver" % "0.31.0" // excludeAll(excludIoGrpc, excludeCatsEffect)
  val opencensusLoggingExporter: ModuleID = "io.opencensus" % "opencensus-exporter-trace-logging"     % "0.31.0" // excludeAll(excludIoGrpc, excludeCatsEffect)
