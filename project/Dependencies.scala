...
object Dependencies {
  ...
  val workbenchModelV  = "0.10-94197dc-SNAP"
  val workbenchGoogleV = "0.15-551809c-SNAP"
  ...
  val workbenchServiceTests: ModuleID = "org.broadinstitute.dsde.workbench" %% "workbench-service-test" % "0.1-bad317f-SNAP" % "test" classifier "tests"
