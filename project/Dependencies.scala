...
//  val stackdriverLogging: ModuleID = "org.springframework.cloud" % "spring-cloud-gcp-logging" % "1.2.8.RELEASE" excludeAll(excludeSpring, excludeSpringBoot)
  ...
  val nettyAll: ModuleID = "io.netty" % "netty-all" % "4.1.119.Final"
  ...
  val googleStorage: ModuleID = "com.google.apis" % "google-api-services-storage" % "v1-rev20250224-2.0.0" excludeAll excludIoGrpc // force this version
  ...
  val okio: ModuleID = "com.squareup.okio" % "okio" % "3.10.2" excludeAll excludeWorkbenchUtil2
