...
object Dependencies {
  ...
  val workbenchGoogle2V = s"0.29-$workbenchLibV"
...
//  val stackdriverLogging: ModuleID = "org.springframework.cloud" % "spring-cloud-gcp-logging" % "1.2.8.RELEASE" excludeAll(excludeSpring, excludeSpringBoot)
  ...
  val googleStorageLocal: ModuleID =
    "com.google.cloud" % "google-cloud-nio" % "0.126.16" % "test" // needed for mocking google cloud storage. Should use same version as wb-libs
