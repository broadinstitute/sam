...
object GoogleServicesConfig {
  ...
  implicit val googlePubSubMonitorConfigReader: ValueReader[GooglePubSubMonitorConfig] = ValueReader.relative { config =>
    GooglePubSubMonitorConfig(
  ...
  implicit val googlePubSubConfigReader: ValueReader[GooglePubSubConfig] = ValueReader.relative { config =>
    GooglePubSubConfig(
      ...
      config.as[GooglePubSubMonitorConfig]("groupSync"),
      config.as[GooglePubSubMonitorConfig]("disableUsers"),
      config.as[GooglePubSubMonitorConfig]("keyCacheMonitor")
    )
  }
  ...
  implicit val googleServicesConfigReader: ValueReader[GoogleServicesConfig] = ValueReader.relative { config =>
    ...
    GoogleServicesConfig(
      ...
      config.as[GooglePubSubConfig]("pubSubManagement"),
