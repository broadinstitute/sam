...
/**
  ...
  * @param enableGracePeriod Set to true if the grace period for ToS acceptance is active
...
case class TermsOfServiceConfig(enabled: Boolean, enableGracePeriod: Boolean, version: Int, url: String)
