...
trait SamModelDirectives {
  ...
  def withSubject(email: WorkbenchEmail, traceContext: SamRequestContext = null): Directive1[WorkbenchSubject] = //todo: create a root span here instead of allowing null?
