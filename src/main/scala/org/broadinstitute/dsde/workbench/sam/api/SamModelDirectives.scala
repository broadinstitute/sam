...
trait SamModelDirectives {
  ...
  def withSubject(email: WorkbenchEmail, samRequestContext: SamRequestContext = null): Directive1[WorkbenchSubject] = //todo: create a root span here instead of allowing null?
