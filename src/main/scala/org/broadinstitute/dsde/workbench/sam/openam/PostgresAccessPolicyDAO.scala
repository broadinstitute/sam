...
class PostgresAccessPolicyDAO(protected val dbRef: DbReference,
  ...
  /**
    ...
    * @return
    */
  def userPoliciesCommonTableExpressions(resourceTypeName: ResourceTypeName, resourceId: Option[ResourceId], user: WorkbenchUserId): UserPoliciesCommonTableExpression = {
    val resource = ResourceTable.syntax("resource")
