...
object Dependencies {
  ...
  val rootDependencies = Seq(
    ...
    "org.broadinstitute.dsde.workbench" %% "workbench-service-test" % "0.1-6dd8128-SNAP" % "test" classifier "tests" excludeAll (excludeWorkbenchGoogle, excludeWorkbenchModel),
    workbenchModel,
    workbenchGoogle,
