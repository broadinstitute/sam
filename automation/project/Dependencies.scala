...
object Dependencies {
  ...
  val rootDependencies = Seq(
    ...
    "org.broadinstitute.dsde.workbench" %% "workbench-service-test" % "0.1-a2e4fb1-SNAP" % "test" classifier "tests" excludeAll (excludeWorkbenchGoogle, excludeWorkbenchModel),
    workbenchModel,
    workbenchGoogle,
