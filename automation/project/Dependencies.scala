...
object Dependencies {
  ...
  val rootDependencies = Seq(
    ...
    "org.broadinstitute.dsde.workbench" %% "workbench-service-test" % "0.1.1-alpha-sam-eb037a4-SNAP" % "test" classifier "tests" excludeAll (excludeWorkbenchGoogle, excludeWorkbenchModel),
    workbenchModel,
    workbenchGoogle,
